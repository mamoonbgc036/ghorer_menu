                      ...
                      <div class="flex items-center">
                        <div class="h-16 w-16 flex-shrink-0">
                          <img
                            ...
                            :alt="food.name"
                          />
                          <div v-else class="h-16 w-16 rounded-lg bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 flex items-center justify-center">
    ...
    <Modal :show="showDeleteModal" @close="showDeleteModal = false">
      <div class="p-6">
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
          Are you sure you want to delete this food item? This action cannot be undone and will also remove all associated extra options.
        </p>
    ...
    <Modal :show="showStatusModal" @close="showStatusModal = false">
      <div class="p-6">
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
          ...
          {{ selectedFood?.is_available ? 'It will no longer be available for ordering.' : 'It will become available for ordering.' }}
        </p>
        <div class="mt-6 flex justify-end space-x-3">
