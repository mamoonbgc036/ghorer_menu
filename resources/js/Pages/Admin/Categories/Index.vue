                  ...
                  <tr v-for="category in categories.data" :key="category.id"
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="relative w-12 h-12">
                        <img v-if="category.image_path" :src="getImageUrl(category.image_path)"
                          class="w-12 h-12 rounded-lg object-cover shadow-sm border border-gray-200 dark:border-gray-600"
                          :alt="category.name" @error="handleImageError" />
                        <div v-else
    ...
    <Modal :show="showDeleteModal" @close="showDeleteModal = false">
      <div class="p-6">
        ...
        <div class="mt-6 flex justify-end space-x-3">
          ...
          <DangerButton class="ml-3" :class="{ 'opacity-25': processing }" :disabled="processing"
