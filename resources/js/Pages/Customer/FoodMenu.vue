    ...
    <CustomerLayout>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="mt-4 lg:mt-0">
                        <div class="flex flex-col items-end">
                            ...
                            <span v-if="orderType === 'delivery'" class="text-sm text-gray-600 dark:text-gray-400">
                                Delivery within {{ branch.delivery_radius }}km
                            </span>
                            <span class="text-sm text-gray-600 dark:text-gray-400">
                                Min. order: £{{ branch.minimum_order }}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <div class="flex items-center space-x-4">
                        <label class="inline-flex items-center">
                            <input type="checkbox" v-model="filterVegetarian"
                        ...
                        <label class="inline-flex items-center">
                            <input type="checkbox" v-model="filterSpicy"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="md:col-span-1">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 sticky top-20">
                        <h2 class="font-semibold text-lg text-gray-900 dark:text-gray-100 mb-4">
                            Menu Categories
                        </h2>
                        <nav class="space-y-1">
                            <button v-for="category in categories" :key="category.id"
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-sm bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded-full">
                                        {{ getFoodsByCategory(category.id).length }}
                                    </span>
                                </div>
                            </button>
                        </nav>
                ...
                <div class="md:col-span-3">
                    <div v-for="category in categories" :key="category.id" :id="`category-${category.id}`"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div v-for="food in filteredFoodsByCategory(category.id)" :key="food.id"
                                ...
                                <div class="p-4">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <div class="flex space-x-2">
                                            <i v-if="food.is_vegetarian" class="fas fa-leaf text-green-500"
                                                title="Vegetarian">
                                            </i>
                                            <i v-if="food.is_spicy" class="fas fa-pepper-hot text-red-500"
                                                title="Spicy">
                                            </i>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <button @click="openFoodModal(food)" :disabled="!food.is_available"
                                            ...
                                            {{ food.is_available ? 'Add to Order' : 'Not Available' }}
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <DialogPanel
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <textarea v-model="specialInstructions" rows="3"
            ...
            <Transition enter-active-class="transform transition ease-out duration-300"
                ...
                leave-active-class="transform transition ease-in duration-300" leave-from-class="translate-y-0"
                            ...
                            <div v-if="showMiniCart" class="mt-4 space-y-2 max-h-60 overflow-y-auto">
                                <div v-for="item in cart" :key="item.id"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span v-if="item.extras.length"
                                            class="ml-2 text-sm text-gray-500 dark:text-gray-400">
                                            ({{ item.extras.map(e => e.name).join(', ') }})
                                        </span>
                                    </div>
                                    <div class="flex items-center space-x-4">
                                        <span class="text-gray-900 dark:text-gray-100">£{{ item.total.toFixed(2)
                                            }}</span>
...
const addToCart = () => {
    const extras = selectedFood.value.extra_options
        .filter(opt => selectedExtras.value.includes(opt.id));
