                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="text-lg font-medium text-orange-600 dark:text-orange-400">
                    ...
                    <div v-else class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Collection Information</h2>
                        <div class="flex items-start space-x-3">
                            <MapPinIcon class="w-5 h-5 text-gray-400 flex-shrink-0" />
                            <div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <button v-for="method in ['card', 'cash']" :key="method"
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">
                            {{ orderType === 'delivery' ? 'Delivery Instructions' : 'Collection Instructions' }}
                        </h2>
                        <textarea v-model="deliveryNotes" rows="3"
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 sticky top-4">
                        ...
                        <div v-if="subtotal < (branch.minimum_order || 0)"
                            ...
                            Minimum order amount is {{ formatCurrency(branch.minimum_order) }}
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <DialogPanel
                            ...
                            <div class="mt-4 space-y-4">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label class="ml-2 text-sm text-gray-700 dark:text-gray-300">Set as default
                                        address</label>
                                </div>
                            </div>
...
const total = computed(() => {
    ...
    return orderType.value === 'delivery' ? baseTotal + deliveryFee.value : baseTotal;
});
