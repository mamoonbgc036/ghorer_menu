                ...
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <div class="relative">
                            ...
                            <input type="text"
                                class="w-64 pl-10 pr-4 py-2 rounded-full border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-orange-500 dark:focus:ring-orange-400"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div class="mt-4 space-y-4">
                            <a href="#"
                                class="block text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">About
                                Us</a>
                            <a href="#"
                                class="block text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">Careers</a>
                            <a href="#"
                                class="block text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">Blog</a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-4 space-y-4">
                            <a href="#"
                                class="block text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">Help
                                Center</a>
                            <a href="#"
                                class="block text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">Safety</a>
                            <a href="#"
                                class="block text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">Terms</a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-4 space-y-4">
                            <a href="#"
                                class="block text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">Restaurants</a>
                            <a href="#"
                                class="block text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">Pricing</a>
                            <a href="#"
                                class="block text-base text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300">Cities</a>
                        </div>
                    </div>
